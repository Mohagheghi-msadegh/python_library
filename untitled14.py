...
def open_new_window():
   ...
   #     l1.pack()
    ...
    search = tk.Button(new_window, text="Search", width=15, height=5,bg="purple",command=Person_search_from_database)
    search.pack(side=tk.LEFT, padx=130, pady=10)

    update = tk.Button(new_window, text="Update", width=15, height=5,bg="red",command=Person_Update)    
    update.pack(side=tk.LEFT, padx=130, pady=10)

    delete = tk.Button(new_window, text="Delete", width=15, height=5, bg="darkblue",command=Person_Delete)
...
def open_new_window1():
    ...
    instance_entry.pack()
    tk.Label(new_window, text="number of avalable:").pack()
    avalable_entry = tk.Entry(new_window)
    avalable_entry.pack()
    

    search = tk.Button(new_window, text="Search", width=15, height=5,bg="purple",command= Book_search_from_database)
    search.pack(side=tk.LEFT, padx=130, pady=10)
...
def open_new_window2():
    ...
    new_window.title("New Window")
    new_window.geometry("300x200")
    label = tk.Label(new_window, text="This is a new window for %s" %employer_list[0])
    label.pack()
...
def open_new_window3():
    ...
    new_window.title("New Window")
    new_window.geometry("300x200")
    label = tk.Label(new_window, text="This is a new window for %s"%reserve_list[1])
    label.pack()
...
def open_new_window4():
    ...
    new_window.title("New Window")
    new_window.geometry("300x200")
    label = tk.Label(new_window, text="This is a new window for %s"%loan_list[1])
    label.pack()
...
for s in range(5):
    if s==0:  
        button = tk.Button(root, width=10, height=2,bg="lightgreen",text=library_list[s], command=open_new_window)
        button.pack(padx=20, pady=20)
    elif s==1:
        button = tk.Button(root, width=10, height=2,bg="lightgreen",text=library_list[s], command=open_new_window1)
        button.pack(padx=20, pady=20)
    elif s==2:
        button = tk.Button(root, width=10, height=2,bg="lightgreen",text=library_list[s], command=open_new_window2)
        button.pack(padx=20, pady=20) 
    elif s==3:
        button = tk.Button(root, width=10, height=2,bg="lightgreen",text=library_list[s], command=open_new_window3)
        button.pack(padx=20, pady=20)   
    elif s==4:
        button = tk.Button(root, width=10, height=2,bg="lightgreen",text=library_list[s], command=open_new_window4)
        button.pack(padx=20, pady=20)     
root.mainloop()
